...
import logo from "../../src/assets/images/Paytm_Logo_(standalone).png";
...
export default function PayTm() {
    ...
    const handleSubmit = async (event) => {
      ...
      try {
        const response = await axios.post(
            `${process.env.REACT_APP_BACKEND_URL}/pay-tm-pay`,
          data
        );
        // Handle success 
    ...
    return (
      <div>
        ...
        <img src={logo} alt="" style={{ marginTop: "20px", height: "40px",   }} />
            <img
            ...
            <div className="mb-3 mt-2">
                <h1 htmlFor="number">Add Amount</h1>
            </div>
